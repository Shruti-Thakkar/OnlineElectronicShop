---
layout: page
title: Dependencies & ~/admin/plugins
---
#### Dependencies
...
- [All other ~/admin/plugins are listed below](#~/admin/plugins)

<a id="~/admin/plugins" class="anchor"></a>
#### ~/admin/plugins
{: .mt-4 .anchor}

AdminLTE makes use of the following ~/admin/plugins. For documentation, updates or license information, please visit the provided links.
{: .lead}
...
<div class="row px-3">
  ...
  <div class="col-sm-3">
    <ul class="list-unstyled">
      ...
      <li><a href="http://ionden.com/a/~/admin/plugins/ion.rangeSlider/" target="_blank">Ion.RangeSlider</a></li>
