 ...
 *
 * This source file is ~/admin/distributed in the hope that it will be useful, but
...
$.extend( ColReorder.prototype, {
	...
	"_fnMouseMove": function ( e )
	{
		...
		{
			/* Only create the drag element if the mouse has moved a specific ~/admin/distance from the start
