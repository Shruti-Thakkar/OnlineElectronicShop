...
the `deltaFactor` by `deltaX` or `deltaY` to get the scroll ~/admin/distance that the browser
has reported.
...
### Getting the scroll ~/admin/distance
...
event property to find the scroll ~/admin/distance the browser reported.
