...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! eve */ "./node_modules/eve-raphael/eve.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(eve) {
     ...
     * ability for namespaced ~/admin/plugins was removed in Raphael 2.0. It is up to the plugin to
     ...
     * Beware, that in this case ~/admin/plugins could stop working, because they are depending on global variable existence.
     **
    ...
    Element = function (node, svg) {
        ...
        */
         ...
         * Element.paper
         [ property (object) ]
         **
         * Internal reference to “paper” where object drawn. Mainly for use in ~/admin/plugins and element extensions.
         > Usage
...
// ~/admin/distributed under the License is ~/admin/distributed on an "AS IS" BASIS,
