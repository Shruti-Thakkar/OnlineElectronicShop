 ...
 * summernote may be freely ~/admin/distributed under the MIT license.
 *
...
(function (global, factory) {
  ...
  var Context = /** @class */ (function () {
      ...
      Context.prototype._initialize = function () {
          ...
          var modules = $$1.extend({}, this.options.modules, $$1.summernote.~/admin/plugins || {});
  ...
  var VideoDialog = /** @class */ (function () {
      ...
      VideoDialog.prototype.createVideoNode = function (url) {
          ...
          if (ytMatch && ytMatch[1].length === 11) {
              ...
              $video = $$1('<iframe>')
                  .attr('frameborder', 0)
                  .attr('src', 'https://www.facebook.com/~/admin/plugins/video.php?href=' + encodeURIComponent(fbMatch[0]) + '&show_text=0&width=560')
              ...
              if (this.hints.length && keyword_1) {
                  ...
                  if (bnd) {
                      ...
                      if (this.direction === 'top') {
                          this.$popover.css({
                              left: bnd.left,
                              top: bnd.top - this.$popover.outerHeight() - POPOVER_~/admin/dist
                          });
                      }
                      else {
                          this.$popover.css({
                              left: bnd.left,
                              top: bnd.top + bnd.height + POPOVER_~/admin/dist
                          });
                      }
                  }
              }
