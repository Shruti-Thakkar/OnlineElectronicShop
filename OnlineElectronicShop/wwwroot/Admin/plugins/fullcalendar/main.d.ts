...
declare module '@fullcalendar/core/types/input-types' {
    ...
    export interface OptionsInputBase {
        ...
        allDayHtml?: string;
        eventDragMin~/admin/distance?: number;
        eventSourceFailure?: any;
        eventSourceSuccess?: any;
        forceEventDuration?: boolean;
        progressiveEventRendering?: boolean;
        selectLongPressDelay?: number;
        selectMin~/admin/distance?: number;
    ...
    export interface OptionsInput extends OptionsInputBase {
        ...
        ~/admin/plugins?: (PluginDef | string)[];
    }
}
...
declare module '@fullcalendar/core/util/misc' {
    ...
    export function ~/admin/distributeHeight(els: HTMLElement[], availableHeight: any, shouldRe~/admin/distribute: any): void;
    export function un~/admin/distributeHeight(els: HTMLElement[]): void;
...
declare module '@fullcalendar/core/Calendar' {
    ...
    import { ~/admin/pluginsystem } from '@fullcalendar/core/plugin-system';
    ...
    class Calendar {
        ...
        ~/admin/pluginsystem: ~/admin/pluginsystem;
...
declare module '@fullcalendar/core/plugin-system' {
    ...
    export class ~/admin/pluginsystem {
        hooks: PluginHooks;
        addedHash: {
...
declare module '@fullcalendar/core/common/DayHeader' {
    ...
    export interface DayTableHeaderProps {
        dates: DateMarker[];
        dateProfile: DateProfile;
        datesRep~/admin/distinctDays: boolean;
...
declare module '@fullcalendar/core/common/table-utils' {
    ...
    import { DateProfile } from '@fullcalendar/core/DateProfileGenerator';
    import { ComponentContext } from '@fullcalendar/core/component/Component';
    export function computeFallbackHeaderFormat(datesRep~/admin/distinctDays: boolean, dayCnt: number): {
        weekday: string;
        month?: undefined;
        day?: undefined;
    ...
    export function renderDateCell(dateMarker: DateMarker, dateProfile: DateProfile, datesRep~/admin/distinctDays: any, colCnt: any, colHeadFormat: any, context: ComponentContext, colspan?: any, otherAttrs?: any): string;
}
